# Sets up the EMI for the one factor model

eminame=paste("./EMIs/EMI_",dataname,"_1FAC",".xlsx",sep="")
...
saveWorkbook(wb, file = paste("./EMIs/EMI_",dataname,"_ONEFAC",".xlsx",sep=""), overwrite = TRUE)
