...
test_random_ghq2 <- runModel(model_random, dev_mode = "ghq2", ghq_size = 3, verbose = 2)
test_random_ghq$LL
test_random_ghq2$LL

test_1f_ghq <- runModel(model_1f, dev_mode = "ghq", ghq_size = 3, verbose = 2)
test_1f_ghq2 <- runModel(model_1f, dev_mode = "ghq2", ghq_size = 3, verbose = 2)

test_1f_ghq$LL
test_1f_ghq2$LL

test_mtmm_ghq <- runModel(model_mtmm, dev_mode = "ghq", ghq_size = 3, verbose = 2)
test_mtmm_ghq2 <- runModel(model_mtmm, dev_mode = "ghq2", ghq_size = 3, verbose = 2)
