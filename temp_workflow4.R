...
test_fixed_ghq <- runModel(model_fixed, dev_mode = "ghq", ghq_size = 4, verbose = 2)
test_fixed_orig <- runModel(model_fixed, dev_mode = "orig", verbose = 2)

test_random_ghq <- runModel(model_random, dev_mode = "ghq", ghq_size = 4, verbose = 2)
test_random_orig <- runModel(model_random, dev_mode = "orig", verbose = 2)

test_1f_ghq <- runModel(model_1f, dev_mode = "ghq", ghq_size = 4, verbose = 2)
test_1f_orig <- runModel(model_1f, dev_mode = "orig", verbose = 2)

test_mtmm_ghq <- runModel(model_mtmm, dev_mode = "ghq", ghq_size = 4, verbose = 2)
...
# test_fixed_ghq6$LL
#
# test_fixed_orig$results
# test_fixed_ghq6$results
#
#
#
#
...
#
#
# test_ghq3 <- runModel(model_random, dev_mode = "ghq", ghq_size = 3)
# test_ghq4 <- runModel(model_random, dev_mode = "ghq", ghq_size = 4)
# test_ghq5 <- runModel(model_random, dev_mode = "ghq", ghq_size = 5)
# test_ghq6 <- runModel(model_random, dev_mode = "ghq", ghq_size = 6)
# test_orig <- runModel(model_random, dev_mode = "orig")
#
# #12688.9436092967
#
#
# test_mtmm_orig <- runModel(m1BWDCE_EMI, dev_mode = "orig")
# test_mtmm_ghq3 <- runModel(m1BWDCE_EMI, dev_mode = "ghq", ghq_size = 3)
# test_mtmm_ghq4 <- runModel(m1BWDCE_EMI, dev_mode = "ghq", ghq_size = 4)
# test_mtmm_ghq5 <- runModel(m1BWDCE_EMI, dev_mode = "ghq", ghq_size = 5)
# test_mtmm_ghq6 <- runModel(m1BWDCE_EMI, dev_mode = "ghq", ghq_size = 6)
#
#
#
# model_fixed <- model_generator(processedDCE, "fixed")
# model_1f <- model_generator(processedDCE, "one-factor")
#
# test_fixed_ghq6 <- runModel(model_fixed, dev_mode = "ghq", ghq_size = 4)
# test_1f_ghq6 <- runModel(model_1f, dev_mode = "ghq", ghq_size = 4)
#
# test_fixed_orig <- runModel(model_fixed, dev_mode = "orig")
# test_1f_orig <- runModel(model_1f,dev_mode = "orig")
#
# test_1f_orig$LL
# test_1f_ghq6$LL
#
...
# test_fixed_orig$results
#
# test_1f_ghq6$results
# test_1f_orig$results
#
# test_ghq6$results
# test_orig$results
#
