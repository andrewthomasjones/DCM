...
test_ghq <- runModel(model_random, dev_mode = "ghq")
...
m1BWDCE_EMI <- loadEMIWorkbook(processedBWDCE, "./TESTING_DUMP/EMI_BWprioritiesDCEpriorities_MTMM-2.xlsx")
test_old_ghq <- runModel(m1BWDCE_EMI, dev_mode = "ghq")
test_old_ghq <- runModel(m1BWDCE_EMI, dev_mode = "orig")
