## KOBEll is building the parameter space before performing any iterations of the estimation procedure.

KOBEll<-function(workingvalues,model,conceptcode,nmaxchoicesetsize,datablock,ndecisionmakersblock,drawsmatrix){
