...
processedBWDCE <- row_join_choicedatasets(processedBW_rem, processedDCE)


processedBW_1krows<-setUp(BWpriorities[1:1000,])
processedDCE_1krows<-setUp(DCEpriorities[1:1000,])
processedBWDCE2 <- col_join_choicedatasets(processedBW_1krows, processedDCE_1krows)
